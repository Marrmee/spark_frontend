...
const url = new URL('https://protocol.poscidondao.com/privacy-policy');
...
export default function Policy() {
  return (
    <div className="p-8 text-gray-300 md:p-12 lg:p-16">
      ...
      <section className="mb-8">
        <p>
          ...
          the PoSciDonDAO Foundation. The use of the Internet pages of the
          PoSciDonDAO Foundation is possible without any indication of personal
      ...
      <section className="mb-8">
        <p>
          ...
          PoSciDonDAO Foundation. By means of this data protection declaration,
      ...
      <section className="mb-8">
        ...
        <p>
          The data protection declaration of the PoSciDonDAO Foundation is based
        ...
        <ul className="list-decimal pl-4">
          ...
          <li>
            <h4 className="font-semibold">Data subject</h4>
            <p>
          ...
          <li>
            <h4 className="font-semibold">Restriction of processing</h4>
            <p>
          ...
          <li>
            <h4 className="font-semibold">Pseudonymisation</h4>
            <p>
          ...
          <li>
            <h4 className="font-semibold">Controller or controller responsible for the processing</h4>
            <p>
          ...
          <li>
            <h4 className="font-semibold">Third party</h4>
            <p>
      ...
      <section className="mb-8">
        ...
        <p>Email: hello@poscidon.com</p>
        <p>Website: https://www.poscidondao.com</p>
      </section>

      <section className="mb-8">
        <h2 className="mb-4 text-2xl font-semibold">3. Cookies</h2>
        <p>
          The Internet pages of the PoSciDonDAO Foundation use cookies. Cookies
        ...
        <p>
          Through the use of cookies, the PoSciDonDAO Foundation can provide the
      ...
      <section className="mb-8">
        ...
        <p>
          The website of the PoSciDonDAO Foundation collects a series of general
        ...
        <p>
          When using these general data and information, the PoSciDonDAO
          Foundation does not draw any conclusions about the data subject. Rather,
          ...
          prosecution in case of a cyber-attack. Therefore, the PoSciDonDAO
          Foundation analyzes anonymously collected data and information
      ...
      <section className="mb-8">
        ...
        <p>
          On the website of the PoSciDonDAO Foundation, users are given the
      ...
      <section className="mb-8">
        <h2 className="mb-4 text-2xl font-semibold">6. Newsletter-Tracking</h2>
        <p>
          ...
          PoSciDonDAO Foundation may see if and when an e-mail was opened by a
        ...
        <p>
          ...
          controller. The PoSciDonDAO Foundation autoEthally regards a
      ...
      <section className="mb-8">
        ...
        <p>
          The website of the PoSciDonDAO Foundation contains information that
      ...
      <section className="mb-8">
        ...
        <ul className="list-decimal pl-4">
          <li>
            <h4 className="font-semibold">Right of confirmation</h4>
            <p>
          ...
          <li>
            ...
            <p>
              ...
              PoSciDonDAO Foundation, he or she may, at any time, contact any
              employee of the controller. An employee of PoSciDonDAO Foundation
            ...
            <p>
              ...
              as processing is not required. An employees of the PoSciDonDAO
              Foundation will arrange the necessary measures in individual cases.
            </p>
          </li>
          <li>
            <h4 className="font-semibold">Right of restriction of processing</h4>
            <p>
              Each data subject shall have the right granted by the European
            ...
            <p>
              ...
              stored by the PoSciDonDAO Foundation, he or she may at any time
              contact any employee of the controller. The employee of the
              PoSciDonDAO Foundation will arrange the restriction of the
              processing.
            </p>
          </li>
          <li>
          ...
          <li>
            ...
            <p>
              The PoSciDonDAO Foundation shall no longer process the personal data
            ...
            <p>
              If the PoSciDonDAO Foundation processes personal data for direct
              ...
              PoSciDonDAO Foundation to the processing for direct marketing
              purposes, the PoSciDonDAO Foundation will no longer process the
            ...
            <p>
              ...
              data concerning him or her by the PoSciDonDAO Foundation for
            ...
            <p>
              ...
              contact any employee of the PoSciDonDAO Foundation. In addition, the
          ...
          <li>
            <h4 className="font-semibold">Automated individual decision-making, including profiling</h4>
            <p>
              Each data subject shall have the right granted by the European
            ...
            <p>
              ...
              controller, or (2) it is based on the data subject&rsquo;s explicit
              consent, the PoSciDonDAO Foundation shall implement suitable
              measures to safeguard the data subject&rsquo;s rights and freedoms
          ...
          <li>
            <h4 className="font-semibold">Right to withdraw data protection consent </h4>
            <p>
              Each data subject shall have the right granted by the European
      ...
      <section className="mb-8">
        ...
        <p>
          ...
          application &ldquo;_gat. _anonymizeIp&rdquo;. By means of this application the IP address of the Internet connection of the data
          subject is abridged by Google and anonymised when accessing our websites
          from a Member State of the European Union or another Contracting State
        ...
        <p>
          ...
          information technology system of the data subject will autoEthally
      ...
      <section className="mb-8">
        ...
        <p>
          ...
          technology system of the data subject is autoEthally prompted to
      ...
      <section className="mb-8">
        <p>
          ...
          <a href="https://willing-able.com/" className="text-blue-400 hover:text-blue-300">LegalTech</a> at Willing & Able that
          also developed the system for{' '}
          <a href="https://abletotrack.com/" className="text-blue-400 hover:text-blue-300">timesheet tracker</a>. The legal
          texts contained in our privacy policy generator have been provided and
          published by{' '}
          <a href="https://dg-datenschutz.de/" className="text-blue-400 hover:text-blue-300">
            Prof. Dr. h.c. Heiko Jonny Maniero
          </a>{' '}
          from the German Association for Data Protection and{' '}
          <a href="https://www.wbs-law.de/" rel="nofollow" className="text-blue-400 hover:text-blue-300">
            Christian Solmecke
          </a>{' '}
          from WBS law.
        </p>
